...
<head>
	<title>Login | Admin Nobels 2021</title>
	<meta charset="utf-8">
	...
	<!-- ICONS -->
	<link rel="apple-touch-icon" sizes="76x76" href="{{asset('style/assets/img/logo-nobels-icon.png')}}">
	<link rel="icon" type="image/png" sizes="96x96" href="{{asset('style/assets/img/logo-nobels-icon.png')}}">
</head>
			...
			<div class="vertical-align-middle">
				<div class="auth-box ">
					<div class="left">
						<div class="content">
							<div class="header">
								<div class="logo text-center"><img src="{{asset('style/assets/img/logo-login.png')}}" alt="Klorofil Logo"></div>
					...
					<div class="right">
						...
						<div class="content text">
							<h1 class="heading">Admin Nobels 2021</h1>
							<p>by Nobels Developer</p>
						</div>
					</div>
